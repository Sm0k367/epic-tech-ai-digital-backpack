...
const TRACKS: Track[] = [
  ...
  {
    id: '23e06613-268f-4736-a632-52b4097df697',
    title: 'Let Me Light It Up',
    genre: 'Hip Hop',
    mood: 'Smooth',
    color: 'from-orange-500/20 to-yellow-500/20',
  },
  {
    id: '2d5066ca-9f23-492c-826b-86e9cc7ff8d3',
    title: 'Juice & Groove',
    genre: 'Electro-Funk',
    mood: 'Groove',
    color: 'from-yellow-500/20 to-orange-500/20',
  ...
  {
    id: '5179aee4-1bfd-4e11-b856-2b44c86ea926',
    title: 'DJ rap Battle',
    genre: 'Hip Hop',
    mood: 'Hype',
    color: 'from-cyan-500/20 to-blue-500/20',
  ...
  {
    id: 'c258caac-288c-423b-a499-fd821dd1ef2b',
    title: 'Glitch in the Machine',
    genre: 'Electronic',
    mood: 'Focus',
    color: 'from-blue-500/20 to-indigo-500/20',
  },
  {
    id: '9410be54-3c4b-486d-a611-b4aee8b638d1',
    title: '420 on the Coast',
    genre: 'Hip Hop',
    mood: 'Smooth',
    color: 'from-orange-500/20 to-yellow-500/20',
  },
  {
    id: 'b18ae518-3b40-4ab6-ab15-ac433809a5a7',
    title: 'Love No More',
    genre: 'Hip Hop',
    mood: 'Smooth',
    color: 'from-orange-500/20 to-yellow-500/20',
